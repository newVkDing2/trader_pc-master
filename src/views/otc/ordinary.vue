  ...
  <div class="otc-ordinary-box main">
    <div class="main-body">
      <div class="max-w">
        <div class="main-content">
          <div class="the-text">
            <p class="ttile1 fit-tc-primary">{{ currCoinLangFun("ordinary_title") }}</p>
            <p class="ttile2 fit-tc-tip">{{ currCoinLangFun("ordinary_aqgxgm") }}</p>
            ...
            <p class="title4 fit-tc-primary">{{ currCoinLangFun("ordinary_fdhbhszb") }}</p>
            <p class="title5 fit-tc-tip">{{ currCoinLangFun("ordinary_advantage") }}</p>
            <div class="instructions">
              <div
                class="instructions-btn fit-background-di fit-tc-primary active-text"
                @click="textClickFun('syxz')"
              >{{ currCoinLangFun("text_use_Instructions", "article") }}</div>
              <div
                class="instructions-btn fit-background-di fit-tc-primary active-text"
                @click="textClickFun('aqgfzd')"
              >{{ currCoinLangFun("text_aqgfzd", "article") }}</div>
            </div>
          </div>
          <div>
            <div class="buy-main">
              ...
              <div class="type-symbol">
                ...
                >
                  <span>
                    {{
                    currCoinLangFun("wanta_buy_text", "buy_coins_relevant")
                    }}
                  </span>
                </div>
                <div
                ...
                >
                  <span>
                    {{
                    currCoinLangFun("wanta_sell_text", "buy_coins_relevant")
                    }}
                  </span>
                </div>
              </div>
              <div class="order-inputs">
                <div class="order-inputs-main">
                    ...
                    <div class="money-input">
                        ...
                        >
                          <span class="el-dropdown-link">
                            <img
                              ...
                              :src="currSource.icon"
                            />
                            <span class="label fit-tc-primary">{{ currSource.label }}</span>
                            <i
                          ...
                          <el-dropdown-menu slot="dropdown" v-if="filterSource.length">
                            <div style="padding: 0 15px">
                              <el-input
                                clearable
                                prefix-icon="el-icon-search"
                                v-model="screenSourceInput"
                                @input="screenSourceChange"
                              ></el-input>
                            </div>

                            <template v-for="item in filterSourceSearch">
                              <el-dropdown-item :key="item.value" :command="item">
                      ...
                      <div>
                        ...
                        >
                          ...
                          <span
                            style="color: #0020FD; cursor: pointer"
                            @click.stop="transferDialog = true"
                  ...
                  <div class="input-box target">
                    <p class="fit-tc-tip title">{{ currCoinLangFun("text_will_get") }}</p>
                    <div class="money-input">
                      <input
                        type="number"
                        onkeypress="return (/[^-^e^+]/.test(String.fromCharCode(event.keyCode)))"
                        ...
                        >
                          <span class="el-dropdown-link">
                            <img
                              ...
                              :src="currTarget.icon"
                            />
                            <span class="label fit-tc-primary">{{ currTarget.label }}</span>
                            <i
                              class="fit-tc-primary otc-symbol-icon el-icon-caret-bottom"
                              :class="{
                          ...
                          <el-dropdown-menu slot="dropdown" v-if="filterTarget.length">
                            <div style="padding: 0 15px">
                              <el-input
                                clearable
                                prefix-icon="el-icon-search"
                                v-model="screenTargetInput"
                                @input="screenTargetChange"
                              ></el-input>
                            </div>
                            <template v-for="item in filterTargetSearch">
                              <el-dropdown-item :key="item.value" :command="item">
                                <img :src="item.icon" alt />
                                <span
                                  class="fit-tc-primary"
                    ...
                    <div class="text">
                      <span class="fit-tc-primary" v-if="currTarget.label && currSource.label">
                        1{{
                        ` ${
                        orderType == "buy"
                        ? currTarget.label
                        ...
                        <div class="payment-trigger">
                          <div class="otc-dropdown">
                            ...
                            >
                              ...
                              >
                                <img class="otc-symbol-img" :src="currPayWay.icon" alt />
                                <span class="otc-symbol-name">{{ currPayWay.name || "" }}</span>
                                <i
                                  class="fit-tc-primary otc-symbol-icon el-icon-caret-bottom"
                                  :class="{
                              ...
                              <el-dropdown-menu slot="dropdown" class="otc-dropdown-payment">
                                <el-dropdown-item
                  ...
                  <div class="order-ways" v-if="orderType == 'sell'">
                        ...
                        <div class="payment-trigger">
                          <div class="otc-dropdown">
                            ...
                            >
                              ...
                              >
                                <img class="otc-symbol-img" :src="currSellWay.icon" alt />
                                <span class="otc-symbol-name">{{ currSellWay.name || "" }}</span>
                                <i
                                  class="fit-tc-primary otc-symbol-icon el-icon-caret-bottom"
                                  :class="{
                    ...
                    <div class="commom-che" v-if="!filterMyPayMethods.length">
                      <div style="font-size: 12px">
                        <div class="fit-tc-tip" v-if="filterMyPayMethodsErr == 1">
                        ...
                        <!--  -->
                        <div class="fit-tc-tip" v-if="filterMyPayMethodsErr == 2">
                          <span>
                            {{
    ...
    <div class="three-steps-box">
      <div class="three-s fit-background-di">
        <div class="max-w">
          <p class="title1 fit-tc-primary">{{ currCoinLangFun("ordinary_steptext1") }}</p>
          <div class="title2">
            <div class="three-min">{{ currCoinLangFun("ordinary_steptext2") }}</div>
            <span class="fit-tc-tip">
              {{
          ...
          <div class="step-img">
            <div class="step">
              ...
              <div class="three-tw">
                <p class="fit-tc-primary">{{ currCoinLangFun("ordinary_steptext4") }}</p>
                <p class="fit-tc-tip">{{ currCoinLangFun("ordinary_steptext5") }}</p>
              </div>
            </div>
            <div class="step">
              <div class="trans-png">
              ...
              <div class="icon-bg"></div>
              <div class="three-tw">
                <p class="fit-tc-primary">{{ currCoinLangFun("ordinary_steptext6") }}</p>
                <p class="fit-tc-tip">{{ currCoinLangFun("ordinary_steptext7") }}</p>
              </div>
            </div>
            <div class="step">
              <div class="trans-png">
              ...
              <div class="icon-bg"></div>
              <div class="three-tw">
                <p class="fit-tc-primary">{{ currCoinLangFun("ordinary_steptext8") }}</p>
                <p class="fit-tc-tip">{{ currCoinLangFun("ordinary_steptext9") }}</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="my-advantage">
        <div class="max-w">
          <p class="title1 fit-tc-primary">{{ currCoinLangFun("ordinary_advantagetext1") }}</p>
          <div class="advantage-detail">
            <div class="detail">
              <div class="icon-bg"></div>
              <p class="fit-tc-primary">{{ currCoinLangFun("ordinary_advantagetext2") }}</p>
              <p class="fit-tc-tip">{{ currCoinLangFun("ordinary_advantagetext3") }}</p>
              <p class="fit-tc-tip">{{ currCoinLangFun("ordinary_advantagetext4") }}</p>
            </div>
            <div class="detail">
              <div class="icon-bg"></div>
              <p class="fit-tc-primary">{{ currCoinLangFun("ordinary_advantagetext5") }}</p>
              <p class="fit-tc-tip">{{ currCoinLangFun("ordinary_advantagetext6") }}</p>
            </div>
            <div class="detail">
              <div class="icon-bg"></div>
              <p class="fit-tc-primary">{{ currCoinLangFun("ordinary_advantagetext7") }}</p>
              <p class="fit-tc-tip">{{ currCoinLangFun("ordinary_advantagetext8") }}</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <el-dialog
      ...
      class="goKyc"
    >
      <p class="fit-tc-tip goKyc-tip">{{ currCoinLangFun("ordinary_yjmbwsxx") }}</p>
...
import { toThousands, toNorounded, analysisFunction } from '@/util/util'
export default {
  components: { businessChatBox, fundTransfer },
  watch: {
    userVariation: {
      handler(data) {
  ...
  created() {
    ...
    getOneClickPayment().then(async (res) => {
      ...
      let sI = -1
      this.filterSource.forEach((item, index) => {
        if (item.local_currency == this.exchangeName) {
          sI = index
        }
      })
      if (sI !== -1) {
        this.currSource = this.filterSource[sI] || {}
      } else {
    ...
    getDataApi('1530464853989064705', {
      config_code: 'fast_article',
    }).then((res) => {
      let data = res.data.data.records
      if (data.length > 0) {
        data = data[0]
        try {
          this.articleCode = analysisFunction(
            `function getData(){${data.config_data}}`
          )()

          console.log(this.articleCode)
        } catch (error) {
          console.warn('解析异常', error, data.config_data)
        }
      }
    })
  },
  methods: {
    ...
    serOrderType(type) {
      ...
      if (sI !== -1 && this.orderType == 'buy') {
        this.chooseSource(this.filterSource[sI])
      } else {
        this.chooseSource(this.filterSource[0])
      }
      ...
      if (
        ...
        this.filterTarget.forEach((item) => {
          this.myPayMethods.forEach((child) => {
            if (child.data && item.value == child.data.country_id) {
              bool = true
              setTimeout(() => {
      ...
      if (!bool) {
        this.chooseTarget(this.filterTarget[0])
      }
    },
    choosePayWay(obj) {
      //选择支付方式
    ...
    closeDialog(type, isRefresh = '') {
      if (type == 'businessChatDialog') {
        ...
        //刷新余额
        this.getCurrencyAccountFun()
      } else if (type == 'transferDialog') {
        this.transferDialog = false
        if (isRefresh == 'refresh') {
          getOneClickPayment().then((res) => {
            let data = res.data.data[0]
            this.coinList = data.coin
            //刷新余额
            this.getCurrencyAccountFun()
            let i = this.filterSource.findIndex(
              (item) => item.id == this.currSource.id
            )
            if (i != -1) {
              this.chooseSource(this.filterSource[i])
            }
          })
        }
      }
    ...
    getCurrencyAccountFun() {
      ...
      getCurrencyAccount({ type: 1 }).then((res) => {
        ...
        this.coinList = this.coinList.map((item) => {
          //匹配对应币种金额
      ...
      let data = {
        ...
        fiatCurrency:
          this.orderType == 'buy'
            ...
            : this.currTarget.label,
        payMethodId:
          this.orderType == 'buy' ? this.currPayWay.id : this.currSellWay.id,
    ...
    textClickFun(type) {
      let article_code =
        type == 'syxz'
          ? this.articleCode.syxz_article_code
          : this.articleCode.azgfzd_article_code
      if (article_code) {
  ...
  computed: {
    ...
    filterSourceSearch() {
      let reg = new RegExp(this.screenSourceInput, 'gi')
      return this.filterSource.filter((item) => item.label.match(reg))
    },
    filterTargetSearch() {
      let reg = new RegExp(this.screenTargetInput, 'gi')
      return this.filterTarget.filter((item) => item.label.match(reg))
    },
    ...
    filterSource() {
      ...
      if (this.orderType == 'buy') {
        filterData = this.countryList.map((item) => {
          item.label = item.local_currency
          item.value = item.id
          return item
        })
    ...
    computedRate() {
      return toThousands(toNorounded(Number(this.exchangeNum), 8))
    },
    exchangeNum() {
      //当前币种兑法币的汇率
      let rate = 0
      if (this.orderType == 'buy') {
        this.exchangeData.forEach((item) => {
          if (
            item.quote_currency == this.currSource.local_currency &&
        ...
        this.exchangeData.forEach((item) => {
          if (
            item.quote_currency == this.currTarget.local_currency &&
